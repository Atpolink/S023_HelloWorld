...
namespace MyTranscript
{
    public partial class Form1 : Form
    {
        ...
        List<Course> IndustrialTraining;
        ...
        public Form1()
        {
            ...
            IndustrialTraining = new List<Course>();
        ...
        private void AddGrade(object sender, EventArgs e)
        {
            ...
            switch (tabControl1.SelectedIndex)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    dataGridViewIT.DataSource = null;
                    IndustrialTraining.Add(newCourse);
                    dataGridViewIT.DataSource = IndustrialTraining;
                    break;
                case 5:
        ...
        private void SaveFile(object sender, EventArgs e)
        {
            ...
            // Year 2 Semester 1
            // สามารถคัดลอกประโยค if มาทั้งหมด แล้วเปลี่ยนชื่อ list
            ...
            // Industrail Training
            if (IndustrialTraining.Count > 0) // เขียนลงไฟล์เมื่อมีข้อมูลใน list เท่านั้น
            {
                sb.AppendLine("");
                sb.AppendLine("IndustrialTraining");
                sb.AppendLine("No, Course ID, Course Name, Credit, Grade");
                counter = 1;
                foreach (var item in IndustrialTraining)
                {
                    sb.AppendLine(counter.ToString() + ", " + item.ToString());
                    counter++;
                }
